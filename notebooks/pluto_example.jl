...
# ╔═╡ 05f8fb87-5c64-4d35-8b95-11530d9dce9e
using Plots, PlutoUI

# ╔═╡ 748f2c86-b154-4bff-81e7-c32c19785d49
@bind α Slider(0.5:0.1:5)

# ╔═╡ c7756aea-7a20-432c-a6a2-4cc7bcc83082
@bind a NumberField(0:1:10)

# ╔═╡ cc7135eb-2e29-4ab5-a926-a7b4f6c27d60
@bind b NumberField(1:1:10)

# ╔═╡ 8f85eb49-1ca7-405d-9b50-d70b6ef0381f
function f(x)
	return sin(α * x) * (a * x + b)
end

# ╔═╡ a25f81b3-3a6c-4f40-a41c-443f003fd54e
x = range(0, 4 * π, 500)

# ╔═╡ 82f180bd-f652-400f-8be3-81ad04ea0fcb
y = f.(x)

# ╔═╡ 8c768978-320a-44e5-b822-fb8f5ff08db7
plot(x, y)
