...
# ╔═╡ e1864f64-0879-11ed-04dd-f925fe304709
using DataFrames, ImageIO, ImageShow, MLDatasets, MLJ, Plots, PlutoUI

# ╔═╡ f0abfe91-c4c4-403a-89f6-ae3eceb50ebd
md"""
## Load training and test set
"""

# ╔═╡ f1e9b0a9-09d5-46e3-a317-4ff6c02a4879
begin
	df_train = MNIST(:train)
	df_test = MNIST(:test)
end

# ╔═╡ ef318b8f-92f6-4514-921e-03bfd861a749
md"""
## Reshape 2D images into flat 1D images
"""

# ╔═╡ 239d2f5b-0f7b-4ec8-b193-686977c3f8f2
begin
	X_train = DataFrame(reshape(df_train.features, (28 * 28, :)), :auto)
	X_test = DataFrame(reshape(df_test.features, (28 * 28, :)), :auto)
	
	y_train = coerce(df_train.targets, OrderedFactor)
	y_test = coerce(df_test.targets, OrderedFactor)
end

# ╔═╡ 50ea6c1e-e5de-4e26-8160-c9bfb5acbf64
md"""
## Visualizations
"""

# ╔═╡ a9e55c7e-c276-4515-80f9-e878b2e34c01
@bind idx Slider(1:50)

# ╔═╡ f434e11a-ba8a-4fc6-b71b-5e86d5dc909c
md"""
Image with index $idx has label $(df_train[idx].targets)
"""

# ╔═╡ 1539608e-ad8f-40e6-a6fc-647083cc2252
md"""
### 2D Image
"""

# ╔═╡ 76f7142c-ac8e-4500-a5a8-7487403a3c96
convert2image(MNIST, df_train[idx].features)

# ╔═╡ b4bde315-27d8-4d4b-8bb2-276adb0f13a3
md"""
### Flattened image
"""

# ╔═╡ 28141991-bd8b-4903-ad30-294a7466865d
convert(Vector{Gray{Float32}}, X_train[:, idx])
